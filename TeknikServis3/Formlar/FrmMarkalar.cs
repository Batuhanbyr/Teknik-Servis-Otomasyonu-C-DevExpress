...
namespace TeknikServis3.Formlar
{
    public partial class FrmMarkalar : Form
    {
        ...
        private void FrmMarkalar_Load(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut2 = new SqlCommand("SELECT TBLKATEGORİ.AD,COUNT(*) FROM TBLURUN INNER JOIN TBLKATEGORİ ON TBLKATEGORİ.ID=TBLURUN.KATEGORI GROUP BY TBLKATEGORİ.AD ", baglanti);
